...
import (
	...
	"github.com/apache/incubator-devlake/plugins/jira_keon_singer/api"
	"github.com/apache/incubator-devlake/plugins/jira_keon_singer/models"
	"github.com/apache/incubator-devlake/plugins/jira_keon_singer/models/migrationscripts"
	"github.com/apache/incubator-devlake/plugins/jira_keon_singer/tasks"
...
func (plugin JiraSinger) PrepareTaskData(taskCtx core.TaskContext, options map[string]interface{}) (interface{}, errors.Error) {
	...
	op.TapProvider = func() (tap.Tap, errors.Error) {
		return tap.NewSingerTapClient(&tap.SingerTapArgs{
			Config:               config,
			TapClass:             "TAP_JIRA",
			StreamPropertiesFile: "jira_keon.json",
		})
	}
	if err != nil {
		return nil, err
