...
func ExtractPr(taskCtx core.SubTaskContext) errors.Error {
	...
	extractor := helper.NewSingerApiExtractor(
		&helper.SingerExtractorArgs[models.GithubPullRequestRecord, models.GithubPullRequestState, models.GithubPullRequestSchema]{
			Ctx:          taskCtx,
			SingerConfig: data.Config,
			ConnectionId: data.Options.ConnectionId,
			Extract: func(resData *models.GithubPullRequestRecord) ([]interface{}, errors.Error) {
			...
			TapClass: "TAP_GITHUB",
			TapSchemaSetter: func(stream *singer.Stream[models.GithubPullRequestSchema]) bool {
